...
export default function () {
    ...
    return <Container>
        ...
        <Space h="md" />
        <p>Last updated on Aug 12th 2024</p>
        <p>
            For the purpose of these Terms and Conditions, The term "we", "us",
            "our" used anywhere on this page shall mean
            celebria collective, whose registered/operational
            office is
            02, hoodi main road, vasantha towers, krishnarajapuram
            Bengaluru
            KARNATAKA
            560036
        ...
        <p>
            <strong>1. Your use of the website and/or purchase from us are governed by following Terms and Conditions:</strong>
        </p>
        <ul>
            <li>
                <p>
            ...
            <li>
                <p>
                    ...
                    celebria collective’s prior written consent.
                </p>
            </li>
            <li>
                <p>
