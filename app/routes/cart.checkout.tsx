            ...
            <Row gutter={[30, 30]}>
                ...
                <Col xs={24} md={8} lg={6}>
                    <Space direction="vertical" size={'middle'}>
                        <Cart.Summary />
                        {user ? <Form action="order/submit"><Button type="primary" htmlType="submit">Proceed to Payment</Button></Form> : <UserLogin title="Login to continue" redirectUrl="/cart/checkout" />}
                    </Space>
                </Col>
            </Row>
        </div>
