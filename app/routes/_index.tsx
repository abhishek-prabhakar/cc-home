...
const jumbotronList = [{
  ...
  dexcription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'
}, {
  label: 'Photography',
  title: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit',
  dexcription: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.'
...
const Jumbotron = () => {
  ...
  return <div style={{ height: '520px', overflow: 'hidden' }}><div style={jumbotronWrapperStyle} >
    <div style={{ ...jumbotronListStyle, width: `calc(80vw * ${jumbotronList.length})`, transform: `translate3d(-40vw, 0px, 0px)` }} >
      {
        jumbotronList.map((item, key) => <div key={'slider-' + key} style={{ transform: active === key ? 'none' : 'scale(0.8)' }}><JumbotronItem key={key} /></div>)
      }
    </div>
  </div></div>;
}
