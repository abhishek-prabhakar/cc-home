        ...
        (r) => {
          resolve(
            r.map((x) => ({
              ...
              label: x.vendorType.name,
              path: `/services/${x.vendorType.keyName}?category=${x.id}`,
              cost: x.serviceGroupItem[0]?.service?.vendorService[0]?.cost,
            }))
          );
        },
        (e) => {
...
const FALLBACK_IMG =
  "https://static.miraheze.org/widdershinswiki/thumb/4/47/Placeholder.png/800px-Placeholder.png";
...
const Home = {
      ...
      <>
        ...
        <Container size={"xl"}>
          <Grid>
            ...
            <Grid.Col span={12}>
              <Image
                src={"/assets/overlay-divider.png"}
                width={"100%"}
                h={90}
                opacity={0.3}
              />
          ...
          <Grid.Col span={12}>
            ...
            <Grid.Col span={12}>
              <Card radius={"md"} withBorder className="card-style-3">
                <Grid
                  gutter={{ base: 20, md: 40 }}
                  align={"center"}
                  justify={"center"}
                >
                  <Grid.Col span={{ base: 12, md: 6 }}>
                    <Stack align="center">
                      <Title className="_text-center" order={3}>
                        We are here to help
                        <br />
                      ...
                      <Flex align={"center"} gap={"md"}>
                        ...
                        <Link to="/collections/commercial">
                              ...
                              <Center>
                                <Avatar.Group>
                                  {response?.map((v) => (
                                    <Avatar
                                      size="lg"
                                      key={v?.profileImageName}
                                      src={PATH.THUMB_URL + v?.profileImageName}
                                    />
                                  ))}
                                </Avatar.Group>
                              </Center>
          ...
          <Grid.Col visibleFrom="md" span={{ base: 12, md: 6 }}>
            <Box className="homepage-hero-search-wrapper" p={"xl"}>
              ...
              <Center>
                <Grid gutter={20} w={"70%"}>
                  <Grid.Col span={12}>
                    <Title className="title-wrapper" order={1}>
                      Bangalore’s luxury
                      <br />
                      wedding{" "}
                      <Typewriter
      ...
      <Grid justify={"space-between"} align={"center"}>
        <Grid.Col span={{ base: 12, md: 2 }}>
          <div className="home-section-card-wrapper">
            ...
            <Text c="dimmed">
              Explore our in-demand services, loved by many.
            </Text>
          </div>
        </Grid.Col>
            ...
            <Await resolve={data.popularServices}>
              {(resolve) => (
                ...
                >
                  ...
                  <ButtonBack className="btn _prev">
                    <IconArrowNarrowLeft />
                  </ButtonBack>
                  <ButtonNext className="btn _next">
                    <IconArrowNarrowRight />
                  </ButtonNext>
                </CarouselProvider>
              )}
      ...
      <Grid justify={"center"}>
        <Grid.Col span={12}>
          <div style={{ paddingTop: "45px" }}>
            <div className="home-section-card-wrapper">
              <Title order={3} className="_text-center">
                Hire the best professionals for any job
              </Title>
            </div>
          </div>
        </Grid.Col>
            ...
            <Await resolve={data.collections}>
              {(response) => (
                ...
                >
                  <Slider className="slider-spacer">
                    {response.map((item, i) => (
                      <Slide className="card-style-2" index={i} key={item.id}>
                        <div className="card-wrapper">
                          <div>
                            ...
                            <div className="btn-wrapper">
                              <Link to={item.path}>
                                <Button radius="xl">Book now</Button>
                              </Link>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="item-spacer">
                      <div className="item">
                        <Stack>
                          {
                            CatIconList.find((x) =>
                              item.title.toLowerCase().includes(x.name)
                            )?.icon
                          }
        ...
        <Grid gutter={20}>
          {modalData?.serviceGroup.map((item, index) => (
            <>
              ...
              (index - 1 < 0 ||
                item.isCollection !==
                  modalData.serviceGroup[index - 1].isCollection) ? (
                <Grid.Col span={{ base: 12 }} key={item.id + "col-" + index}>
                  <Title order={5}>Other services</Title>
                </Grid.Col>
              ) : (
                ""
              )}
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          width: "100%",
                          height: "100%",
                          background: collectionBg[index % 2],
                          display: "flex",
                          alignItems: "center",
                      ...
                      >
                        <Title
                          order={4}
                          style={{ wordBreak: "normal", color: "white" }}
                        >
                          {item.name}
                        </Title>
                        <div
                  ...
                  <Link to={item.path}>
                    ...
                    >
                      ...
                      <div
                        style={{
                          background:
                            "linear-gradient(0deg, rgb(2, 0, 36, 0.3) 0%, rgb(9, 9, 121, 0.3) 35%, rgb(0, 212, 255, 0.3) 100%)",
                          position: "absolute",
                          top: 0,
                          left: 0,
                          width: "100%",
                      ...
                      >
                        <Title
                          order={5}
                          style={{ color: "white", wordBreak: "normal" }}
                        >
                          {item.name}
                        </Title>
                      </div>
          ...
          {!modalData?.serviceGroup.length && (
            <Grid.Col span={12}>
              Sorry, no services found under this category.
            </Grid.Col>
          )}
        </Grid>
      </Modal>,
      ...
      <Suspense fallback={<Skeleton />}>
        <Await resolve={data.topVendors}>
          {(res) => (
            <Grid gutter={20}>
              <Grid.Col span={12}>
                <Title order={3}>Top service providers</Title>
              </Grid.Col>
              {res.map((category) => (
                <Grid.Col key={"ce" + category.id} span={{ base: 12, md: 3 }}>
                  <div className="home-section-card-wrapper">
                    <Stack>
                      <Title order={5}>{category.name}</Title>
                      {category.vendor.map((vendor, i) => (
                        <Grid
                          key={vendor.username}
                          gutter={20}
                          align={"center"}
                        >
                          ...
                          <Grid.Col>
                            <Avatar
                              src={
                                vendor.profileImageName
                                  ? PATH.THUMB_URL + vendor.profileImageName
                          ...
                          <Grid.Col flex={"auto"}>
                            ...
                            >
                              <Link
                                to={Routes.get("VendorProfile", {
                                  id: vendor.username,
                                })}
                              >
                                <Text fw={500}>{vendor.username}</Text>
                              </Link>
                            </div>
                          </Grid.Col>
                        </Grid>
                      ...
                      <Text>
                        <Link
                          to={Routes.get("Services", { id: category.keyName })}
                        >
                          View all
                        </Link>
                      </Text>
        ...
        <Await resolve={data.bannerAds}>
          {(response) => (
            ...
            >
              <Slider className="slider-spacer">
                {response.map((item, i) => (
                  <Slide key={"s" + item.bannerLocation} index={i}>
                    <Link to={item.url}>
                      <Card withBorder p={3}>
                        <Card
                          mih={200}
                          className="animate-banner-ad"
                          style={{
                            backgroundImage:
                              "url(/assets/card-gradient-overlay.png), url(" +
                              item.img +
                              ")",
                          }}
                        >
                          ...
                          <Stack gap={0} justify="center" align="center">
                            ...
                            <Space h={"md"} />
                            <Box>
                              <Button variant="white" radius="lg">
                                Book now
                              </Button>
                            </Box>
                          </Stack>
  ...
  KeyFeatures() {
    return (
      <Grid pt={"xl"} gutter={"lg"} align="center" justify="center">
